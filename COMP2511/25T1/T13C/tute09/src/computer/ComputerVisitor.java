...
public class ComputerVisitor {
    ...
    public static void main(String[] args) {
        ComputerComponent c = new Computer("Very Slow CSE Computer", 1024, 16);
        ComputerComponent k = new Keyboard("Mechanical Keyboard");
        ComputerComponent m = new Mouse("Broken CSE Mouse", 1600);
